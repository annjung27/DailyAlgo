...
/**
   ...
   */
function combineStrings(string1, stirng2, string3) {
    return string3 + string1 + stirng2;
}
...
function stringRepeat(string, num) {
    ...
    for(let i=0; i< num; i++){
        stringRepeating+= string;
    }
    return stringRepeating;    
}

test = stringRepeat("Hello ", 3);
console.log(test, "repeated string 3 times");
...
/**
   ...
   */
function milesToEmpty(milesPergallon, gasInTank) {
  return milesPergallon * gasInTank;
}

test = milesToEmpty(2, 10);
console.log("this car can go", test, "miles before running gas");
...
/**
  ...
  var arr1 = ["hello", "hi", "annie"]
  test = totalWordsLength(arr1);
  console.log("total word length in the given array: ", test);
  ...
  var arr1 = ["hello", "hi", "annie"]
  test= avgWordLength(arr1);
  console.log("Average length of the words in the given array: ", test);
...
test = findLongestWord(arr2);
console.log("The logest word is: ", test);
   ...
   */
  function inclusiveRangeSum(num1, num2) {
    let sum = 0;
  ...
  test = inclusiveRangeSum(1,5);
  console.log("sum is ", test);
