...
function usingSpread(items1=[], items2=[]){
  let newArr = [];
  newArr = [...items1, ...items2];
  return newArr;
}
...
const result3 = usingSpread(arrA1, arrB1);
console.log(result3, "should be", expected1);

const result4 = usingSpread(arrA2, arrB2);
console.log(result4, "should be", expected2);
